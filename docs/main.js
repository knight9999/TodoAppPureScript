...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["MainPage"] = $PS["MainPage"] || {};
  var exports = $PS["MainPage"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_Except_Trans = $PS["Control.Monad.Except.Trans"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  ...
  var TodoWorking = (function () {
      ...
      TodoWorking.value = new TodoWorking();
      return TodoWorking;
  })();
  var TodoFinished = (function () {
      function TodoFinished() {

      };
      TodoFinished.value = new TodoFinished();
      return TodoFinished;
  })();
  var StoreTodo = function (x) {
      return x;
  };
  var OptionAll = (function () {
      function OptionAll() {

      };
      OptionAll.value = new OptionAll();
      return OptionAll;
  })();
  var Option = (function () {
  ...
  var SelectOption = (function () {
      function SelectOption(value0) {
          this.value0 = value0;
      };
      SelectOption.create = function (value0) {
          return new SelectOption(value0);
      };
      return SelectOption;
  })();
  var Submit = (function () {
  ...
  var valueFromTodoState = function (v) {
      if (v instanceof TodoWorking) {
          return 0;
      };
      if (v instanceof TodoFinished) {
          return 1;
      };
      throw new Error("Failed pattern match at MainPage (line 51, column 22 - line 53, column 20): " + [ v.constructor.name ]);
  };
  var writeForeignStoreTodo = new Simple_JSON.WriteForeign(function (v) {
      return Simple_JSON.writeImpl(Simple_JSON.recordWriteForeign()(Simple_JSON.consWriteForeignFields(new Data_Symbol.IsSymbol(function () {
          ...
          id: v.id,
          comment: v.comment,
          stateValue: valueFromTodoState(v.state)
      });
  });
  var valueFromOption = function (v) {
      if (v instanceof OptionAll) {
          return -1 | 0;
      };
      if (v instanceof Option) {
          return valueFromTodoState(v.value0);
      };
      throw new Error("Failed pattern match at MainPage (line 85, column 19 - line 87, column 35): " + [ v.constructor.name ]);
  };
  var todoStateFromValue = function (v) {
      if (v === 0) {
          return TodoWorking.value;
      };
      return TodoFinished.value;
  };
  var storageKey = "todos-purescript-demo";
  var saveData = function (todos) {
      var text = Simple_JSON.writeJSON(Simple_JSON.writeForeignArray(writeForeignStoreTodo))(Data_Functor.map(Data_Functor.functorArray)(StoreTodo)(todos));
      return function __do() {
          var w = Web_HTML.window();
          var storage = Web_HTML_Window.localStorage(w)();
          return Web_Storage_Storage.setItem(storageKey)(text)(storage)();
      };
  };
  var readForeignStoreTodo = new Simple_JSON.ReadForeign(function (text) {
      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(Simple_JSON.readImpl(Simple_JSON.readRecord()(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
          ...
          return "stateValue";
      }))(Simple_JSON.readInt)(Simple_JSON.readFieldsNil)()())()())()()))(text))(function (v) {
          return Control_Applicative.pure(Control_Monad_Except_Trans.applicativeExceptT(Data_Identity.monadIdentity))({
              id: v.id,
              comment: v.comment,
              state: todoStateFromValue(v.stateValue)
          });
      });
  });
  var loadData = function __do() {
      var w = Web_HTML.window();
      var storage = Web_HTML_Window.localStorage(w)();
      var maybeText = Web_Storage_Storage.getItem(storageKey)(storage)();
      if (maybeText instanceof Data_Maybe.Just) {
          var v = Simple_JSON.readJSON(Simple_JSON.readArray(readForeignStoreTodo))(maybeText.value0);
          if (v instanceof Data_Either.Left) {
              Data_Semigroup_Foldable.traverse1_(Data_List_Types.foldable1NonEmptyList)(Effect.applyEffect)(Effect_Console.logShow(Foreign.showForeignError))(v.value0)();
              return [  ];
          };
          if (v instanceof Data_Either.Right) {
  ...
  var labelFromTodoState = function (v) {
      if (v instanceof TodoWorking) {
          return "\u4f5c\u696d\u4e2d";
      };
      if (v instanceof TodoFinished) {
      ...
      throw new Error("Failed pattern match at MainPage (line 46, column 22 - line 48, column 23): " + [ v.constructor.name ]);
  };
  var labelFromOption = function (v) {
      if (v instanceof OptionAll) {
          return "\u3059\u3079\u3066";
      };
      if (v instanceof Option) {
          return labelFromTodoState(v.value0);
      };
      throw new Error("Failed pattern match at MainPage (line 80, column 19 - line 82, column 35): " + [ v.constructor.name ]);
  };
  var initialState = function (v) {
      return {
          todos: [  ],
          selectedOption: OptionAll.value,
          options: [ OptionAll.value, new Option(TodoWorking.value), new Option(TodoFinished.value) ],
          counter: 0
      };
  };
  var eqTodoState = new Data_Eq.Eq(function (x) {
      return function (y) {
          if (x instanceof TodoWorking && y instanceof TodoWorking) {
              return true;
          };
          if (x instanceof TodoFinished && y instanceof TodoFinished) {
              return true;
          };
          return false;
      };
      ...
      return function (dictMonadEffect) {
          return function (v) {
              if (v instanceof Init) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(loadData))(function (todos) {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          ...
                          $55.todos = todos;
                          $55.counter = Data_Array.length(todos);
                          return $55;
                      });
                  });
              };
              if (v instanceof SelectOption) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                      ...
                      $58.selectedOption = v.value0;
                      return $58;
                  });
              };
              if (v instanceof ChangeState) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (s) {
                      var toggle$prime = function (x) {
                          if (x instanceof TodoWorking) {
                              return TodoFinished.value;
                          };
                      ...
                      var todos = Data_Functor.map(Data_Functor.functorArray)(function (x) {
                          var $63 = Data_Eq.eq(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
                              return "state";
                          }))(eqTodoState))()(new Data_Symbol.IsSymbol(function () {
                              return "id";
                          }))(Data_Eq.eqInt))()(new Data_Symbol.IsSymbol(function () {
                              return "comment";
                          }))(Data_Eq.eqString)))(v.value0)(x);
                          if ($63) {
                              return {
                                  state: toggle$prime(x.state),
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (s1) {
                              return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(saveData(s1.todos));
                          });
                      });
                  });
              };
              if (v instanceof DeleteTodo) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (s) {
                      var todos = Data_Array.filter(function (x) {
              ...
              if (v instanceof Submit) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(v.value0)))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (s) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Control_Bind.bindFlipped(Effect.bindEffect)(Control_Bind.composeKleisliFlipped(Effect.bindEffect)((function () {
                              var $90 = Web_DOM_ParentNode.querySelector("[ref=\"comment\"]");
                              return function ($91) {
                                  return $90(Web_HTML_HTMLDocument.toParentNode($91));
                              };
                          })())(Web_HTML_Window.document))(Web_HTML.window)))(function (mel) {
                              var maybeComment = Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Web_HTML_HTMLInputElement.fromElement)(mel);
                              if (maybeComment instanceof Data_Maybe.Just) {
                                  return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(function __do() {
                                      var val = Web_HTML_HTMLInputElement.value(maybeComment.value0)();
                                      Web_HTML_HTMLInputElement.setValue("")(maybeComment.value0)();
                                      return val;
                                  }))(function (val) {
                                      var $73 = val !== "";
                                      if ($73) {
                                          return Control_Applicative.pure(Effect_Aff.applicativeAff)((function () {
                                              ...
                                              $74.todos = Data_Array.concat([ s.todos, [ {
                                                  id: s.counter,
                                                  comment: val,
                                                  state: TodoWorking.value
                                              } ] ]);
                                              $74.counter = s.counter + 1 | 0;
                                              return $74;
                                          })());
                                      };
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                  ...
                                  $78.todos = state.todos;
                                  $78.counter = state.counter;
                                  return $78;
                              }))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(saveData(state.todos)))(function () {
  ...
  var visibleTodos = function (option) {
      return function (todos) {
          var isVisible = function (todo) {
              if (option instanceof OptionAll) {
                  return true;
              };
  ...
  var eqOption = new Data_Eq.Eq(function (x) {
      return function (y) {
          if (x instanceof OptionAll && y instanceof OptionAll) {
              return true;
          };
          if (x instanceof Option && y instanceof Option) {
              return Data_Eq.eq(eqTodoState)(x.value0)(y.value0);
          };
          return false;
      };
  });
          ...
          return function (state) {
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.attr("id")("app") ])(Data_Array.concat([ [ Halogen_HTML_Elements.h1([  ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.attr("href")("https://github.com/knight9999/MoonLanderPureScript"), Halogen_HTML_Properties.attr("target")("_blank"), Halogen_HTML_Properties.attr("style")("text-decoration: none; color: black;") ])([ Halogen_HTML_Core.text("\u30c1\u30e5\u30fc\u30c8\u30ea\u30a2\u30ebToDo\u30ea\u30b9\u30c8") ]) ]) ], Data_Functor.map(Data_Functor.functorArray)(function (opt) {
                  return Halogen_HTML_Elements.label([  ])([ Halogen_HTML_Elements.input((function () {
                      ...
                      var $88 = Data_Eq.eq(eqOption)(opt)(state.selectedOption);
                      if ($88) {
                          return Data_Array.cons(Halogen_HTML_Properties.attr("checked")("checked"))(list);
                      };
                      return list;
                  })()), Halogen_HTML_Core.text(labelFromOption(opt)), Halogen_HTML_Core.text(" ") ]);
              })(state.options), [ Halogen_HTML_Core.text("\uff08" + (Data_Int.toStringAs(Data_Int.decimal)(Data_Array.length(visibleTodos(state.selectedOption)(state.todos))) + " \u4ef6\u3092\u8868\u793a\uff09")) ], [ Halogen_HTML_Elements.table([  ])([ Halogen_HTML_Elements.thead([  ])([ Halogen_HTML_Elements.tr([  ])([ Halogen_HTML_Elements.th([ Halogen_HTML_Properties.attr("class")("id") ])([ Halogen_HTML_Core.text("ID") ]), Halogen_HTML_Elements.th([ Halogen_HTML_Properties.attr("class")("comment") ])([ Halogen_HTML_Core.text("\u30b3\u30e1\u30f3\u30c8") ]), Halogen_HTML_Elements.th([ Halogen_HTML_Properties.attr("class")("state") ])([ Halogen_HTML_Core.text("\u72b6\u614b") ]), Halogen_HTML_Elements.th([ Halogen_HTML_Properties.attr("class")("button") ])([ Halogen_HTML_Core.text("-") ]) ]) ]), Halogen_HTML_Elements.tbody([  ])(Data_Functor.map(Data_Functor.functorArray)(function (todo) {
                  return Halogen_HTML_Elements.tr((function () {
                      var $89 = Data_Eq.eq(eqTodoState)(todo.state)(TodoFinished.value);
                      if ($89) {
                          return [ Halogen_HTML_Properties.attr("class")("done") ];
                      };
                      return [  ];
                  })())([ Halogen_HTML_Elements.th([  ])([ Halogen_HTML_Core.text(Data_Int.toStringAs(Data_Int.decimal)(todo.id)) ]), Halogen_HTML_Elements.td([  ])([ Halogen_HTML_Core.text(todo.comment) ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.attr("class")("state") ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (x) {
                      return Data_Maybe.Just.create(new ChangeState(todo));
                  }) ])([ Halogen_HTML_Core.text(labelFromTodoState(todo.state)) ]) ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.attr("class")("button") ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (x) {
                      return Data_Maybe.Just.create(new DeleteTodo(todo));
                  }) ])([ Halogen_HTML_Core.text("\u524a\u9664") ]) ]) ]);
              })(visibleTodos(state.selectedOption)(state.todos))) ]) ], [ Halogen_HTML_Elements.h2([  ])([ Halogen_HTML_Core.text("\u65b0\u3057\u3044\u4f5c\u696d\u306e\u8ffd\u52a0") ]), Halogen_HTML_Elements.form([ Halogen_HTML_Properties.attr("class")("add-form"), Halogen_HTML_Events.onSubmit(function ($92) {
                  return Data_Maybe.Just.create(Submit.create($92));
              }) ])([ Halogen_HTML_Core.text("\u30b3\u30e1\u30f3\u30c8 "), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.attr("type")("text"), Halogen_HTML_Properties.attr("ref")("comment") ]), Halogen_HTML_Core.text(" "), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.attr("type")("submit") ])([ Halogen_HTML_Core.text("\u8ffd\u52a0") ]) ]) ] ]));
          };
      };
  };
  var component = function (dictMonadAff) {
      return function (dictMonadEffect) {
          return Halogen_Component.mkComponent({
              ...
              render: render(dictMonadAff)(dictMonadAff.MonadEffect0()),
...
(function($PS) {
  ...
  var MainPage = $PS["MainPage"];                
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Halogen_VDom_Driver.runUI(MainPage.component(Effect_Aff_Class.monadAffAff)(Effect_Aff.monadEffectAff))(Data_Unit.unit)(body);
  }));
  exports["main"] = main;
})(PS);
PS["Main"].main();